...
const updateBooks = async (id, available) => {
    try {
        const SQL = `UPDATE books SET available=$1 WEHRE is=$2 RETURNING *`;
...
module.exports = { createBook, getBooks, getBook, deleteBook, updateBooks };
